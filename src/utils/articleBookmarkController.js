...
import { patchProfileSessionBookmark } from './profileSessionCache';
...
export function emitBookmarkToggle({ articleId, isBookmarked, article }) {
  ...
  patchProfileSessionBookmark(id, isBookmarked, card || article);
}
...
/** Optimistic bookmark toggle shared by feeds, detail, and profile cards. */
