// web/src/utils/Service/mockNotificationApi.js
    ...
    constructor() {
        this.notifications = [
            ...
            },
            {
                id: "7",
                type: "keyword",
                text: "New article about Technology",
                keyword: "technology",
                time: "4h ago",
                read: false,
                important: false,
                details: "A new article matching your 'technology' keyword has been published.",
                user: "Tech News",
                avatar: "📱",
                postTitle: "Latest Technology Trends"
            },
            {
                id: "8",
                type: "like",
                text: "Emma liked your comment",
                keyword: null,
                time: "6h ago",
                read: true,
                important: false,
                details: "Emma liked your comment on the article about web development.",
                user: "Emma Wilson",
                avatar: "👩‍💻",
                postTitle: "Web Development Best Practices"
            }
        ];
    }
